...
<head>
  ...
  <meta name="apple-mobile-web-app-title" content="Summer Adventure">
  <link rel="manifest" href="manifest.webmanifest">
  <link rel="apple-touch-icon" href="assets/pig-cape.png">
  <title>Summer Adventure Check-in</title>
  <style>
    :root {
...
const manifest = {
  name: 'Summer Adventure Check-in',
  ...
  theme_color: '#29aeca',
  icons: [
    { src: 'assets/pig-cape.png', sizes: '512x512', type: 'image/png', purpose: 'any maskable' }
  ]
};
